...
export const NewScheduleModal: React.FC<ModalProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const isNotice = formData.category === 'Notice' || formData.category === '공지';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-[#1C1C1E] rounded-3xl w-full max-w-md p-8 shadow-2xl animate-fade-in-up border border-transparent dark:border-[#38383A]">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-2xl font-semibold text-[#1D1D1F] dark:text-white">새 일정 추가</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder={isNotice ? "예: 전체 회의 시간 변경 안내" : "예: 교구 연합 제자 훈련"}
            />
          </div>
